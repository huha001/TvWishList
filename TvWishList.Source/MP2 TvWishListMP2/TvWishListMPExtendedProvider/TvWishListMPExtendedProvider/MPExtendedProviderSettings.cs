...
namespace MediaPortal.Plugins.TvWishListMPExtendedProvider.Settings
{
  class MPExtendedProviderSettings
  {
    /// <summary>
    /// Holds the host name or IP adress of the MpExtended service (running on same machine as TvServer).
    /// </summary>
