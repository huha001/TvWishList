...
//****************
//Version 1.0.0.2 //static class made
//****************
...
//file copied from Tvserver log.cs and modified
namespace TvLibrary.Log.huha
{
    /// <summary>
    ...
    public class Log
    {
        ...
        {
            GetFileName(LogType.Error);
            WriteToFile(LogType.Error, "TvWishList Error:");
            WriteToFile(LogType.Error, format, arg);
            WriteToFile(LogType.Error, "");
            WriteToFile(LogType.Info, "TvWishList Error:");
            WriteToFile(LogType.Info, format, arg);
            WriteToFile(LogType.Info, "");
        }
